...
namespace Microsoft.MixedReality.OpenXR.Remoting
{
    ...
    public static class AppRemoting
    {
        ...
        public static System.Collections.IEnumerator Connect(RemotingConfiguration configuration)
        {
            ...
            {
                Debug.Log("[AppRemoting] Connect InitializeLoader");
                yield return XRGeneralSettings.Instance.Manager.InitializeLoader();
            }

            if (XRGeneralSettings.Instance.Manager.activeLoader != null)
            {
                Debug.Log("[AppRemoting] Connect StartSubsystems");
        ...
        public static void Disconnect()
        {
            ...
            if (XRGeneralSettings.Instance.Manager.activeLoader != null)
            {
                ...
                Debug.Log("[AppRemoting] Disconnect StopSubsystems");

                if (XRGeneralSettings.Instance.Manager.isInitializationComplete)
                {
                    XRGeneralSettings.Instance.Manager.DeinitializeLoader();
                    Debug.Log("[AppRemoting] Disconnect DeinitializeLoader");
                }
            }
        }
