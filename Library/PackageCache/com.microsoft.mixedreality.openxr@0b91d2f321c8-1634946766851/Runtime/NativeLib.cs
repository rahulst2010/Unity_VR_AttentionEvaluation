...
namespace Microsoft.MixedReality.OpenXR
{
    ...
    internal class NativeLib
    {
        ...
        // Configure Unity's ILCPP compiler to process C# string (always UTF16) interop to C++ "const char*".
        // Unity by default is converting to UTF8 when compiling ILCPP code for pinvoke.
        // Using the [MarshalAs(UnmanagedUTF8Type)] string to make this conversion more explicity.
        ...
        internal static extern IntPtr GetInstanceProcAddr(ulong instance, IntPtr xrGetInstanceProcAddr, [MarshalAs(UnmanagedUTF8Type)] string functionName);
        ...
        [DllImport(DllName, EntryPoint = "openxr_plugin_UpdateTrackingStateFlags")]
        internal static extern void UpdateTrackingStateFlags(NativeLibToken token, FrameTime frameTime, ref NativeSpaceLocationFlags flags);
