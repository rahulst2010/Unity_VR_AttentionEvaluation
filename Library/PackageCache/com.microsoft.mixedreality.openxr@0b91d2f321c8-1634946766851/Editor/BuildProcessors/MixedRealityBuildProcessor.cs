...
namespace Microsoft.MixedReality.OpenXR.Editor
{
    ...
    internal class MixedRealityBuildProcessor : OpenXRFeatureBuildHooks
    {
        ...
        private bool IsHoloLensFeatureEnabled(string path) =>
            CheckFeatureEnabled<MixedRealityFeaturePlugin>() ||
            CheckFeatureEnabled<HandTrackingFeaturePlugin>();
        ...
        //  </remarks>
        static internal T GetOpenXRFeature<T>() where T : class
        {
        ...
        private static bool IsLoaderEnabledForTarget(BuildTargetGroup buildTargetGroup)
        {
